...
export default function KnowledgeGate(): React.ReactElement {
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      const sourcesPayload = sourcesRes.data as unknown as { sources: PDFSource[]; total: number } | PDFSource[]
      setSources(Array.isArray(sourcesPayload) ? sourcesPayload : sourcesPayload.sources)
    } catch {
